...
This is an [HT (Heiervang Technologies)](https://github.com/heiervang-technologies) fork of [mergekit](https://github.com/arcee-ai/mergekit). For full details on branch conventions, sync workflow, and contribution process, see the [Fork Management Guide](https://github.com/orgs/heiervang-technologies/discussions/3).
...
For all questions and inquiries about this fork, please use the [HT Discussions](https://github.com/orgs/heiervang-technologies/discussions) page. For non-fork-specific contributions intended to flow upstream, follow the upstream mergekit contribution guidelines below.
